<?php 
    ...
    class DocenteDAO implements IDocente
    {
        public function Listar(){
            ...
            echo '<tr>';
            echo '<td><strong>Numero de pedido</strong></td>';
            echo '<td><strong>Fecha de registro</strong></td>';
            echo '<td><strong>Personal Encargado</strong></td>';
            echo '<td><strong>Detalle</strong></td>';
            echo '<td><strong>Tipo de entrega</strong></td>';
            echo '</tr>';
